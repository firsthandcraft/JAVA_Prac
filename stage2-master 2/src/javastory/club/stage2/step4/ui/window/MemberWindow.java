package javastory.club.stage2.step4.ui.window;
...
import javastory.club.stage2.step4.logic.MemberHelper;
import javastory.club.stage2.step4.logic.ClubCoordinator;
...
public class MemberWindow {
	...
	public void modify() {
		...
		while(true) {
	        ...
	        if (!memberHelper.exist(currentClub.getName(), email)) {
	        	narrator.sayln("\t > No such member -> " + email);
	        	continue;
	        }
