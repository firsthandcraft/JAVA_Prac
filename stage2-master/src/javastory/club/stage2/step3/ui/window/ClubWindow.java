package javastory.club.stage2.step3.ui.window;

import javastory.club.stage2.step1.entity.TravelClub;
import javastory.club.stage2.step3.logic.ClubCoordinator;
import javastory.club.stage2.util.ConsoleUtil;
import javastory.club.stage2.util.Narrator;
import javastory.club.stage2.util.TalkingAt;
...
public class ClubWindow {
	...
	public TravelClub register() {
		...
		while(true) {
			...
			if (clubName.equals("0") || clubName.equals("")) {
				break;
			}
	...
	public TravelClub modify() {
		...
		while(true) {
			...
			if (clubCoordinator.exist(newName)) {
				narrator.sayln("Club already exists with name --> " + newName);
				continue;
			}
